                      ...
                      <View style={styles.locationCardContent}>
                        ...
                        {index === 0 ? (
                          ...
                          <View style={styles.locationCardIcon}>
                            <View style={[styles.locationIconCircle, { backgroundColor: index === 2 ? '#5CC463' : '#47AFF4' }]} />
                          </View>
                        )}
                      </View>
                    </TouchableOpacity>
                    ...
                    >
                      ...
                      <View style={styles.emotionCardIcon}>
                        {emotion.emotion === '행복' || emotion.emotion === '기쁨' ? (
                          ...
                          <Svg width="108" height="83" viewBox="0 0 108 83" fill="none">
                          ...
                          <Svg width="75" height="71" viewBox="0 0 396 557" fill="none">
                            <Defs>
                              <ClipPath id={`clip0_sad_${index}`}>
                                <Rect width="396" height="557" fill="white"/>
                              </ClipPath>
                            </Defs>
                            <G clipPath={`url(#clip0_sad_${index})`}>
...
const styles = StyleSheet.create({
  ...
  locationCardSvgContainerSecond: {
    position: 'absolute',
    top: -8, // 카드 상단에서 -8px 위치
    left: 131, // 카드 왼쪽에서 131px 떨어진 위치
    width: 215,
    height: 96,
    justifyContent: 'center',
    alignItems: 'center',
